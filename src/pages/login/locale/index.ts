const i18n = {
  'en-US': {
    'login.form.title': 'Login to Goal Admin',
    'login.form.userName.errMsg': 'Phone cannot be empty',
    'login.form.password.errMsg': 'Password cannot be empty',
    'login.form.login.errMsg': 'Login error, please refresh and try again',
    'login.form.userName.placeholder': 'Phone',
  ...
  'zh-CN': {
    'login.form.title': '登录 Goal Admin',
