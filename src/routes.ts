...
export const routes: IRoute[] = [
    ...
    children: [
      {
        ...
        key: 'system/user',
        requiredPermissions: [
          { resource: 'menu.system.user', actions: ['read', 'write'] },
        ],
      },
      {
        name: 'menu.system.login_history',
        key: 'system/login-history',
        requiredPermissions: [
          { resource: 'menu.system.login_history', actions: ['read', 'write'] },
        ],
      },
      {
        ...
        key: 'system/config',
        requiredPermissions: [
          { resource: 'menu.system.config', actions: ['read', 'write'] },
        ],
      },
      {
        name: 'menu.system.info',
        key: 'system/info',
        requiredPermissions: [
          { resource: 'menu.system.info', actions: ['read', 'write'] },
        ],
      },
      {
        ...
        key: 'system/logs',
        requiredPermissions: [
          { resource: 'menu.system.logs', actions: ['read', 'write'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      {
        name: 'menu.profile.info',
        key: 'profile/info',
      },
      {
        name: 'menu.profile.setting',
        key: 'profile/setting',
      },
    ],
  },
